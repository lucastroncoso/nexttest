                    ...
                    <div className="my-16">
                        ...
                        <div className="py-12">
                            ...
                            <div className="mt-4 flex justify-center">
                                <div className="rounded-full border border-blue-600 text-blue-600 py-3 px-8 text-center"><a href="" className="link">Consulta las oportunidades aquí</a></div>
                            </div>
                        </div>
