...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/scripts/app.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
const routes_1 = __webpack_require__(/*! ./ts/routes */ "./assets/scripts/ts/routes.ts");
const Main = class Main {
    constructor(_routes = new routes_1.Routes()) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.content = exports.categories = void 0;
exports.categories = [
    ...
    { id: 7, title: "Pagos y recargas", description: "Paga y recarga servicios en cualquier momento" }
];
exports.content = [
    {
    ...
    {
        "question": "¿Qué empresa es la que presta los servicios relacionados con mi cuenta Ualá?",
        "answer": "Los servicios relacionados con la emisión, administración, redención y transmisión de fondos de pago electrónico son prestados única y exclusivamente por Belanea México S.A.P.I. de C.V., actualmente en proceso de autorización para operar como institución de fondos de pago electrónico, en cumplimiento de la disposición Octava transitoria de la Ley para Regular las Instituciones de Tecnología Financiera, por lo que la operación actual no es una actividad supervisada por las autoridades mexicanas. Asimismo, las tarjetas que se utilicen como medio de disposición de los referidos fondos son emitidas por Belanea México S.A.P.I. de C.V., quien es responsable de su operación.",
        "category": 1
    },
    {
    ...
    {
        "question": "¿Puedo descargar la app de Ualá en una computadora o un celular con sistema operativo Windows?",
        "answer": "No, la app de Ualá solo se puede descargar y usar desde celulares con sistema operativo Android (versión 4.4 o superior) o iOS (9 o superior).",
        "category": 2
    },
    {
    ...
    {
        "question": "¿Cómo me registro en Ualá?",
        "answer": "1. Descarga la app desde PlayStore o App Store. 2. Ingresa a la app de Ualá. 3. Te vamos a pedir que selecciones o escribas tu e-mail y crees tu contraseña. 4. Te pediremos tu mail y celular para validarlos; se te enviará un mail y un SMS, respectivamente. 5 Una vez validados solicitaremos algunos datos personales, tu CURP, una selfie y un par de fotografías de tu identificación oficial. Al terminar, revisa que tus datos están correctos. 6. Registra tu domicilio y dónde quieres recibir tu Ualá. (puede ser la misma dirección que registraste u otra) y ¡listo! Una vez que termines el registro nos toca trabajar a nosotros para validar tus datos. En general aprobaremos tu cuenta en un máximo de 3 días hábiles. En caso de ser aprobada, te enviaremos tu tarjeta Ualá en un periodo de 1 hasta 5 días hábiles.",
        "category": 2
    },
    {
        "question": "¿Para qué me piden fotos de la INE y una selfie?",
        "answer": "En Ualá priorizamos tu seguridad. Por eso te vamos a pedir foto de tu INE/IFE y una selfie para asegurarnos que eres tú y así poder aprobar tu cuenta y enviarte la tarjeta. Si las fotos se ven mal o si tu INE está vencida, no vamos a poder avanzar con tu validación ni darte la tarjeta. En el caso de ser extranjero se te pedirá tu tarjeta de residencia temporal o permanente y tu CURP.",
        "category": 2
    },
    {
        "question": "¿Para qué sirve la opción de “Congelar cuenta”?",
        "answer": "Puedes usar la opción de “Congelar” para inhabilitar temporalmente las compras y operaciones con la tarjeta. Puede ser porque no encuentras tu tarjeta Ualá y no estás seguro que la perdiste. Si es así, entonces, por prevención, congela tu tarjeta y escríbenos por el chat de la app de Ualá. Recuerda mantenerte en línea, así podemos responderte. Después puedes descongelar la tarjeta desde la sección “Tarjeta” deslizando el botón “Congelar” hacia la izquierda.",
        "category": 2
    },
    {
        "question": "¿Puedo solicitar una tarjeta de débito Ualá si soy extranjero?",
        "answer": "¡Claro! Solo tienes que contar con tu tarjeta de residencia temporal o permanente en México y tener tu CURP.",
        "category": 2
    },
    {
        "question": "¿Dónde actualizo mis datos personales o mi domicilio?",
        "answer": "Para cualquier modificación de tus datos personales, escríbenos por el chat de la app de Ualá o puedes enviar un mail a hola@uala.com.mx para poder ayudarte. Recuerda que para poder responderte a través del chat, deberás quedarte en línea.",
        "category": 2
    },
    {
    ...
    {
        "question": "¿Cuándo tengo disponible el depósito que realice?",
        "answer": "Si depositas saldo a través de tiendas de autoservicio, por transferencia vía SPEI y de Ualá a Ualá el depósito es inmediato.",
        "category": 3
    },
    {
        "question": "¿Hay un monto mínimo para hacer un depósito a mi tarjeta Ualá?",
        "answer": "No. Puedes recargar el monto que necesites. Ten en cuenta que la tienda de autoservicio te cobrará una comisión de entre $8 hasta $10 pesos misma que se te regresará al día siguiente, SIEMPRE.",
        "category": 3
    },
    {
        "question": "¿Dónde puedo realizar un retiro de efectivo con mi tarjeta Ualá?",
        "answer": "Para realizar retiros de efectivo tienes dos opciones. 1.Puedes hacerlo en cualquier Walmart, Bodega Aurrera, Superama y Sam´s del país. Recuerda que los retiros son gratis en compras mínimas de $15 pesos, para retiros sin compras el establecimiento te cobrará una comisión de 5 pesos y podrás retirar hasta $2,000 MN. 2.Puedes realizar retiros en cualquiera de los más de 60,000 ATM Cirrus a nivel nacional. Para hacerlo: 1. Recuerda el PIN que generaste en el registro. 2. Ingresa la tarjeta en el cajero. 3. Digita el PIN de 4 dígitos. 3.Selecciona la opción “retiro” y luego “tarjeta de débito\"ó \"Cuenta de ahorro\" dependiendo del cajero en el que estés. ¡Listo! Ya puedes realizar tu retiro. Recuerda que Ualá no cobra comisión en ninguna operación y te bonifica dos veces al mes hasta $25 pesos la comisión del cajero. A partir del tercer retiro por mes, el banco donde realizaste tu operación te cobrará una comisión de entre $15 y $45 pesos. Puedes revisar las comisiones de los bancos aquí: https://www.gob.mx/condusef/prensa/compara-las-comisiones-antes-de-usar-un-cajero-automatico-diferente-al-tuyo.En",
        "category": 3
    },
    {
        "question": "¿Cuál es el límite diario de retiro en cajeros automáticos?",
        "answer": "El límite de retiros por ATM es de hasta $9,000 cada 24 horas. Solo puedes retirar el saldo disponible que tengas en tu cuenta Ualá, es decir que si tu saldo es de $1,500, solo puedes retirar hasta $1,500, menos la comisión que el banco del cajero te cobre por realizar el retiro. Recuerda que Ualá no cobra comisión en ninguna operación y te bonifica dos veces al mes hasta $25 pesos la comisión del cajero. A partir del tercer retiro por mes, el banco donde realizaste tu operación te cobrará una comisión de entre $15 y $45 pesos. Puedes revisar las comisiones de los bancos aquí: https://www.gob.mx/condusef/prensa/compara-las-comisiones-antes-de-usar-un-cajero-automatico-diferente-al-tuyo.",
        "category": 3
    },
    {
        "question": "¿Los retiros en efectivo tienen algún costo?",
        "answer": "Ualá no cobra comisión en ninguna operación y te bonifica hasta $25 pesos la comisión del cajero dos veces al mes. A partir del tercer retiro por mes, el banco donde realizaste tu operación te cobrará una comisión de entre $15 y $45 pesos. Puedes revisar las comisiones de los bancos aquí: https://www.gob.mx/condusef/prensa/compara-las-comisiones-antes-de-usar-un-cajero-automatico-diferente-al-tuyo.",
        "category": 3
    },
    {
        "question": "¿Hay un monto máximo de saldo?",
        "answer": "El saldo de tu cuenta no tiene un límite. Ten en cuenta que puedes depositar un máximo de 3 mil UDIS* por mes (aproximadamente $19,000 pesos).",
        "category": 3
    },
    {
        "question": "¿Los retiros en el extranjero tienen algún costo?",
        "answer": "Sí. Se cobrará la comisión del banco donde realices tu retiro.",
        "category": 3
    },
    {
    ...
    {
        "question": "¿Cuándo me entregan mi tarjeta de débito Ualá Mastercard?",
        "answer": "Si aprobamos tu usuario, vamos a crear tu cuenta e imprimir tu tarjeta. Este proceso puede llevar hasta 3 días hábiles. Después, el correo Estafeta va a entregar tu tarjeta en el domicilio que indicaste en el registro. La entrega de la tarjeta se realizará en un periodo de 1 hasta 5 días hábiles.",
        "category": 4
    },
    {
        "question": "¿A dónde envían mi tarjeta de débito Ualá Mastercard?",
        "answer": "La tarjeta de débito Ualá Mastercard se envía al domicilio de entrega que tú nos indiques al registrarte en la app de Ualá. Puedes elegir dónde recibir la tarjeta Ualá: tu domicilio particular o completar un domicilio alternativo. Para entregar tu tarjeta Ualá tiene que haber un mayor de 18 años para recibirla cuando el correo haga la visita.",
        "category": 4
    },
    {
    ...
    {
        "question": "¿Puedo usar mi tarjeta Ualá para comprar a plazos?",
        "answer": "Por el momento sólo puedes comprar en un único pago.",
        "category": 4
    },
    {
        "question": "¿Dónde puedo usar mi tarjeta Ualá?",
        "answer": "La puedes usar en cualquier comercio y/o sitio web del mundo que acepten Mastercard como medio de pago. Usa tu Ualá para comprar en el supermercado o comprar juegos online, pagar la cena en un restaurante o las entradas del cine, suscribirte a servicios digitales. Usa Ualá para todo. Recuerda, si aceptan Mastercard, aceptan Ualá.",
        "category": 4
    },
    {
    ...
    {
        "question": "Puse mi tarjeta como medio de pago en un sitio web y me descontaron saldo en la app. ¿Por qué?",
        "answer": "Los sitios y plataformas web pueden retener un monto de dinero para validar tu tarjeta Ualá Mastercard. Este monto te lo reintegran automáticamente. Si no te hacen el reintegro, ponte en contacto con el comercio para realizar el reclamo.",
        "category": 4
    },
    {
        "question": "Intenté realizar una compra con mi tarjeta de débito Ualá Mastercard y me sale rechazada, ¿qué tengo que hacer?",
        "answer": "Recuerda que Ualá es una tarjeta de débito y necesitas tener saldo para poder realizar cualquier compra. Así que, asegurate de tener el monto suficiente para hacer la compra. Si la compra que quieres hacer es online, el sitio te puede pedir que selecciones el tipo de tarjeta. 1. Prueba seleccionando el tipo de tarjeta como débito y si la página te indica que ingreses un banco, elige “otros”. 2. Asegurate que estés ingresando los datos de la tarjeta tal cual aparecen en ella: tu nombre, el n° de tarjeta, el vencimiento, el CVV (código de seguridad de 3 dígitos que aparece en la parte de atrás de tu tarjeta Ualá). 3. Si te piden un domicilio de facturación, ingresa tu domicilio. Recuerda que solo puedes comprar en un pago y no en plazos. Las compras de servicios digitales de origen extranjero no tendrán cargos sobre el valor de la compra por el IVA. Si la compra es presencial, asegurate que el comercio ingrese tu tarjeta Ualá en su terminal como tarjeta de débito, en un pago y con los datos correctos. Si revisaste estos pasos y sigues sin poder finalizar tu compra, escríbenos por el chat de la app de Ualá(recuerda mantenerte en línea así podemos responderte) o bien mándanos un mail a hola@uala.com.mx",
        "category": 4
    },
    {
        "question": "¿Puedo domiciliar un servicio de débito automático en mi Tarjeta de débito Ualá Mastercard?",
        "answer": "Sí, puedes usar tu tarjeta de débito Ualá Mastercard para domiciliar un pago automático. Comunicate con el comercio que quieres asociar y asegurate de siempre tener saldo cargado en tu cuenta Ualá, de lo contrario el pago saldrá rechazado",
        "category": 4
    },
    {
...
Ve a un cajero de HSBC, Scotiabank o CitiBanamex y haz una consulta de saldo o retiro de dinero (Debes hacer esta visita a cualquiera de las tres redes en menos de 24 horas, de lo contrario tendrás que realizar el proceso nuevamente). 
    ...
    {
        "question": "Perdí mi celular, ¿qué tengo que hacer?",
        "answer": "Si en tu celular quedó la app de Ualá abierta, escribe un mail a hola@uala.com.mx contándonos esto mismo. Vamos a cerrar la sesión de la app en tu celular extraviado para proteger tus datos y para que puedas bajar la app en un nuevo celular e iniciar sesión con tu mismo usuario y contraseña sin problemas. Ten en cuenta que no pueden haber dos sesiones abiertas en la app de la misma cuenta, por eso es necesario que cerremos manualmente la sesión en el celular extraviado para que puedas utilizar la app en otro celular.",
        "category": 5
    },
    {
        "question": "Perdí o me robaron mi celular y mi tarjeta Ualá, ¿qué tengo que hacer?",
        "answer": "Primero tienes que denunciar la pérdida o robo de la tarjeta. Desde México o el extranjero al  (55) 8896 8252 o al *UALA (*8252) desde tu celular y sigue los siguientes pasos. 1.-Digita tu número de celular a 10 dígitos. 2.- Ingresa tu fecha de nacimiento.3.- Seleciona si tu tarjeta fue robada o extraviada. Si en tu celular quedó la app de Ualá abierta, escríbenos un mail a hola@uala.com.mx para avisarnos lo que te pasó. Vamos a cerrar la sesión de la app en tu celular extraviado para proteger tus datos y para que puedas bajar la app en un nuevo celular e iniciar sesión con tu mismo usuario y contraseña sin problemas. Ten en cuenta que no pueden haber dos sesiones abiertas en la app de la misma cuenta por ello es necesario que cerremos manualmente la sesión en el celular extraviado para que puedas utilizar la app en otro celular.",
        "category": 5
    },
    {
        "question": "¿Cómo ingreso a la Comunidad Ualá?",
        "answer": "Para ingresar a la Comunidad Ualá, tienes dos posibilidades. Si no eres usuario de Ualá, tienes que registrarte en la Comunidad y crear un usuario con el email en el que te registraste en la app de Ualá. De esta manera podrás compartir contenido y comentar o preguntar tus dudas en la Comunidad. Si eres usuario de Ualá, tienes que acceder con el mismo usuario y contraseña que usas en la app.",
        "category": 5
    },
    {
    ...
    {
        "question": "¿Cómo puedo transferir dinero a otro usuario Ualá?",
        "answer": "Desde tu app debes de acceder a \"Transferencias\" y después a la sección \"Tiene Ualá\". Para hacer la transferencia necesitarás el mail del usuario a quien le quieres enviar el dinero, recuerda que tiene que ser el mail con el que se registró en la app de Ualá.",
        "category": 6
    },
    {
        "question": "¿Cómo puedo recibir una transferencia interbancaria (SPEI) a mi cuenta Ualá?",
        "answer": "¡Si quieres tener saldo en tu tarjeta Ualá también lo puedes hacer por transferencia electrónica! Solo necesitarás tener tu CLABE de 18 dígitos, revisar que la entidad financiera sea \"STP\", después el monto y por último el nombre del propietario de la cuenta Ualá.",
        "category": 6
    },
    {
        "question": "¿Para qué sirve la CLABE?",
        "answer": "Es un número único e irrepetible asignado a una cuenta. La CLABE está formada por un conjunto de 18 dígitos numéricos y sirve para  para el envío y recepción de transferencias electrónicas de fondos.",
        "category": 6
    },
    {
        "question": "¿Cómo obtengo mi CLABE para hacer transferencias por SPEI?",
        "answer": "Desde la app de Ualá podrás obtener tu CLABE. Necesitas ir a la sección \"Tarjeta\" y luego en \"Formas de depositar\" selecciona la opción \"Por transferencia\". ¡Y listo! Copia tu CLABE para poder recibir transferencias. Recuerda marcar la opción \"STP\" como entidad financiera.",
        "category": 6
    },
    {
        "question": "¿Cómo puedo hacer una transferencia electrónica de mi tarjeta Ualá a otra cuenta?",
        "answer": "Desde la app de Ualá tienes que ir a la sección \"Transferencias\" y seleccionar la opción \"No tiene Ualá\". Ingresa la CLABE de la cuenta a la cual quieres hacer la transferencia y la entidad financiera, por último, agrega el nombre del titular y el monto.",
        "category": 6
    },
    {
        "question": "¿ Cómo consultar el estatus de mi transferencia SPEI?",
        "answer": "Si quieres saber el status de tu transferencia tienes que ingresar a esta página: https://www.banxico.org.mx/cep/ Recuerda tener a la mano tu clave de rastreo o número de referencia, fecha en la que se realizó la transferencia, la institución emisora y receptora, la cuenta beneficiaria (a quién le enviaste la transferencia) y el monto. Aquí podrás obtener el CPE (comprobate de pago electrónico).",
        "category": 6
    },
    {
        "question": "¿Puedo pagar servicios, tiempo aire y comprar una tarjeta de regalo desde la app de Ualá?",
        "answer": "¡Sí! Desde la app de Ualá tienes que ir a \"Pagos\" y después seleccionar el trámite que quieres hacer: 1.-Pago de servicios agua, teléfono, TV, internet, gas, luz, pagos gubernamentales, peaje y más), 2.-Recarga de tiempo aire (Telcel, Movistar, AT&T, Virgin Mobile), 3.-Tarjetas de regalo (servicios de streaming, compras online, cine, juegos de videos y mucho más).",
        "category": 7
    },
    {
        "question": "¿Cómo puedo pagar servicios desde la app de Ualá?",
        "answer": "Es muy fácil y recuerda que no cobramos comisión. En tu app de Ualá tendrás que ir a la sección de \"Pagos\" y seleccionar \"Pago de servicios\". Después te recomendamos ir a \"ver todos\" para que conozcas las diferentes opciones que tenemos. Una vez que seleccionaste el servicio podrás escanear el código o bien anotar el número de referencia. ¡Y listo!",
        "category": 7
    },
    {
...
class Api {
    get(resource) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield fetch(API_HOST + resource, {
                headers: {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Carrers = void 0;
const $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js-exposed");
const templates_1 = __webpack_require__(/*! ./templates */ "./assets/scripts/ts/templates.ts");
class Carrers {
    constructor(_templates = new templates_1.Templates()) {
    ...
    getCarrers() {
        ...
        fetch('https://www.comeet.co/careers-api/2.0/company/54.00B/positions?token=45B15C715C78B6273322D88B6D111A22D11')
            ...
            document.querySelectorAll("[data-carrer]").forEach((element) => {
...
exports.Carrers = Carrers;


/***/ }),

/***/ "./assets/scripts/ts/faq.ts":
/*!**********************************!*\
  !*** ./assets/scripts/ts/faq.ts ***!
  \**********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Faq = void 0;
const faqs_1 = __webpack_require__(/*! ../json/faqs */ "./assets/scripts/json/faqs.ts");
const templates_1 = __webpack_require__(/*! ./templates */ "./assets/scripts/ts/templates.ts");
class Faq {
    constructor(_templates = new templates_1.Templates()) {
        this._templates = _templates;
    ...
    bind() {
        ...
        document.getElementById("searchFaq").addEventListener("input", event => {
            let value = document.getElementById("searchFaq").value;
            if (value) {
    ...
    drawCategories() {
        ...
        faqs_1.categories.forEach(category => {
        ...
        document.getElementById("faqsCategories").childNodes.forEach((element) => {
            element.addEventListener("click", () => {
                this.drawFaqs(Number(element.dataset["category"]));
            });
        });
    }
    drawFaqs(category, search = false) {
        document.querySelectorAll("[data-faqcategorypage]").forEach(element => {
            element.classList.add("hide");
        });
        document.querySelectorAll("[data-faqcontentpage]").forEach(element => {
        ...
        let faqsContentHTML = "";
        let categoryData = faqs_1.categories.filter(c => c.id == category)[0];
        faqs_1.content.forEach(faq => {
        ...
        document.getElementById("faqsContent").childNodes.forEach((element) => {
            element.addEventListener("click", () => {
...
class Home {
    load() {
        let registerStepActive = true;
        let registerStep = 0;
        window.onscroll = function (event) {
            let registerStepsElement = document.querySelector("#registerSteps");
...
/***/ "./assets/scripts/ts/promotion.ts":
/*!****************************************!*\
  !*** ./assets/scripts/ts/promotion.ts ***!
  \****************************************/
/*! no static exports found */
...
const api_1 = __webpack_require__(/*! ./api */ "./assets/scripts/ts/api.ts");
const templates_1 = __webpack_require__(/*! ./templates */ "./assets/scripts/ts/templates.ts");
class Promotion {
    getAllPromotions() {
        return __awaiter(this, void 0, void 0, function* () {
            let _api = new api_1.default();
            let _templates = new templates_1.Templates();
            let allPromotions = yield _api.get("/promotions");
            let promotions = "";
    ...
    getPromotion(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let _api = new api_1.default();
            let _templates = new templates_1.Templates();
            let promotion = yield _api.get(`/promotion/${id}`);
...
const navbar_1 = __webpack_require__(/*! ./navbar */ "./assets/scripts/ts/navbar.ts");
const faq_1 = __webpack_require__(/*! ./faq */ "./assets/scripts/ts/faq.ts");
const home_1 = __webpack_require__(/*! ./home */ "./assets/scripts/ts/home.ts");
const carrers_1 = __webpack_require__(/*! ./carrers */ "./assets/scripts/ts/carrers.ts");
const promotion_1 = __webpack_require__(/*! ./promotion */ "./assets/scripts/ts/promotion.ts");
class Routes {
    constructor(_navbar = new navbar_1.Navbar(), _faq = new faq_1.Faq(), _home = new home_1.Home(), _carrers = new carrers_1.Carrers(), _promotion = new promotion_1.Promotion()) {
        this._navbar = _navbar;
        this._faq = _faq;
        this._home = _home;
        this._carrers = _carrers;
    ...
    init() {
        ...
        if (this.actualRoute.header)
            $("header").load(`${modulesFolder}/header.html`, () => {
                this._navbar.bind();
            });
        if (this.actualRoute.footer)
            $("footer").load(`${modulesFolder}/footer.html`);
...
/***/ "./assets/scripts/ts/templates.ts":
/*!****************************************!*\
  !*** ./assets/scripts/ts/templates.ts ***!
  \****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Templates = exports.BBCode = void 0;
class BBCode {
    /**
     * @param {Object} codes
     */
